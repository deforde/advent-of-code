#[allow(dead_code)]
pub fn day_1_part_1(input: &[i32], sum: &i32, n: i32) -> Option<i32> {
    for i in 0..input.len() {
        ...
        if n_remaining == 1 {
            ...
            result = day_1_part_1(&input[i..], &y, n_remaining);
        }
        match result {
